                ...
                <div className='Regform'>
                    ...
                    <form onSubmit={(e) => this.submitHandler(e)} >
                        ...
                        <div>
                            ...
                            <input type="tel" name="phoneNumber" placeholder='phone number..' value={phoneNumber} onChange={this.changeHandler} required /><br />
                        </div>
                    ...
                    <Link to='/'>
                        Already have an account click to login<br />
                    </Link>
                </div>
            </div>
        )
